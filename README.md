...
| Mensajes | `/mensajes/` | Pantalla principal (arranca en "Grabar mensaje"): escribir o grabar un mensaje, elegir tono/idioma/voz, mejorarlo con IA (GPT, con filtro de contenido ofensivo/amenazas) y generar el audio final. También lista/gestiona ("Mis voces") las voces clonadas, guarda un **historial de mensajes** (local, en el navegador) y permite enviarlo por **WhatsApp, Microsoft Teams o correo** (audio y/o texto, según el canal). |
